...
- Facebook：通过已登录 `BoxSofa Europe` 主页后台直接上传 6 张原始 PNG，并点击最终“发帖”。提交后页面出现成功信号，但刷新后主页时间线未显示本次文案或活动链接；页面可见 6 张新照片链接（如 `https://www.facebook.com/photo/?fbid=122109347841392989&set=pb.61591789692090.-2207520000` 等），公开图文帖 permalink 尚未确认。不要重复上传本批海报，待 Facebook 平台生成/显示 feed 帖后再补录链接；若 24 小时后仍无帖，应人工检查主页“照片”和“帖子”后台状态。
