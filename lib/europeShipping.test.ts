...
import { europeDeliveryCountries, europeDeliveryCountryCodes, isEuropeDeliveryCountry } from "./europeShipping.ts";
...
test("exports delivery country codes from the configured country list", () => {
  assert.deepEqual(
