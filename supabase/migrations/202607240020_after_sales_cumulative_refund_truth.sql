-- Reassert the after-sales transaction function with order-wide refund allocation locking.
-- Reassert the after-sales transaction function with nullable amount clearing.
