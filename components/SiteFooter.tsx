...
const footerCopy = {
  ...
  en: {
    ...
    cardSoon: "Stripe / card payment reserved",
  ...
  es: {
    ...
    cardSoon: "Stripe / pago con tarjeta reservado",
  ...
  fr: {
    ...
    cardSoon: "Stripe / carte bancaire réservé",
  ...
  de: {
    ...
    cardSoon: "Stripe / Kartenzahlung reserviert",
