...
const footerCopy = {
  ...
  en: {
    ...
    cardSoon: "Free basic delivery across Europe",
  ...
  es: {
    ...
    cardSoon: "Entrega básica gratuita en toda Europa",
  ...
  fr: {
    ...
    cardSoon: "Livraison de base gratuite dans toute l'Europe",
  ...
  de: {
    ...
    cardSoon: "Kostenlose Standardlieferung in ganz Europa",
